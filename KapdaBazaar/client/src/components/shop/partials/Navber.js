...
const Navber = (props) => {
  ...
  return (
    <Fragment>
      {/* Navber Section */}
      <nav className="fixed top-0 w-full z-20 shadow-lg lg:shadow-none bg-white change">
        <div className="m-4 md:mx-12 md:my-6 grid grid-cols-4 lg:grid-cols-3">
          ...
          <div className="col-span-2 lg:hidden flex justify-items-stretch	 items-center">
            ...
            <span
              ...
              className="flex items-left text-center font-bold uppercase text-gray-800 text-2xl cursor-pointer px-2 text-center new-font"
            >
              KapdaBazaar
            </span>
          </div>
          <div
            ...
            className="hidden lg:block flex items-left col-span-1 text-center text-gray-800 font-bold tracking-widest uppercase text-2xl cursor-pointer new-font"
          >
            KapdaBazaar
          </div>
